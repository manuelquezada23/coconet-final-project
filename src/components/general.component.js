                ...
                <div className="SettingsMain">
                    ...
                    <div className="SettingsBody">
                        <div className="SettingsSideBar">
                            ...
                            <div className="SettingsSideBarContent" style={{backgroundColor: "#F2C70F"}} onClick={() => {this.sendToPage(`/${currentUser.id}/settings-general`)}}>
                ...
                <div className="SettingsMain">
                    ...
                    <div className="SettingsBody">
                        <div className="SettingsSideBar">
                            ...
                            <div className="SettingsSideBarContent" style={{backgroundColor: "#F2C70F"}} onClick={() => {this.sendToPage(`/sp/${currentUser.id}/settings-general`)}}>
                                <p style={{marginTop: "10px", marginLeft: "15px"}}>General</p>
                            </div>
