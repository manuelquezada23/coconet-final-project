...
export default class SP extends Component {
    ...
    getTutorial(id) {
      ...
      addCurrentProjects() {
        ...
        AuthService.get_cl(this.props.match.params.id)
          .then(response => {
            this.setState({
    ...
    render() {
        ...
        return (
            ...
            <h3 className="SPSideBarBox" onClick={() => {this.sendToPage(`/sp/${currentTutorial.id}`)}}>About</h3>
                    ...
                    <h3 style={{color: "#F2C70F"}} className="SPSideBarBox" onClick={() => {this.sendToPage(`/sp/${currentTutorial.id}/previous-clients`)}}>Previous Clients</h3>
